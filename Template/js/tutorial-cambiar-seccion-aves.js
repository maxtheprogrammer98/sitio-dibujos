...
function cambiarContador(boton){
    ...
    switch (contador) {
        // materiales
        case 1:
            imagenPortada.src = "../Imagenes/aguila-proceso.jpg";
        ...
        // paso 1
        case 2:
            imagenPortada.src = "../Imagenes/paso1-aves.jpg";
        ...
        // paso 2
        case 3:
            imagenPortada.src = "../Imagenes/paso2-aves.jpg";
            seccionMateriales.style.display = "none";
            seccionPaso1.style.display = "none";
        ...
        // paso 3
        case 4:
            imagenPortada.src = "../Imagenes/paso3-aves.jpg";
            seccionMateriales.style.display = "none";
            seccionPaso1.style.display = "none";
            seccionPaso2.style.display = "none";
